...
#    check v.uint32 == 0x0008_BEEF'u32
  test "Indirect peripheral, write to the dim register at index 1 SHOULD work":
    let p = DIMPERIPH
    mockInitRegs()
    p.DREG(1).write(0x0002_F00D'u32)
